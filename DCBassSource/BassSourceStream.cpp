...
BassSourceStream::BassSourceStream(LPCTSTR objectName, HRESULT &hr, CSource* filter, LPCWSTR name, 
  LPCTSTR filename, ShoutcastEvents* shoutcastEvents, int buffersizeMS, int prebufferMS)
